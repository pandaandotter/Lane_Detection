...
def preprocess_image(image_path: str, mode: str, target_size: int = 80):
...
def main(processing_mode: str):
    ...
    image_path = "15.jpg"  # Replace with your test image path

    img_cropped, img_input = preprocess_image(image_path, processing_mode)
    model_name = f"UFDL_{processing_mode.lower()}.h5"
